...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: { en: "Game designer / solo studio", es: "Diseñador de juegos / estudio en solitario" },
    summary: {
      en: "\"One stone. One flick. The whole ocean.\" A physics-driven stone-skipping game aiming for best-in-class mobile arcade polish, with a real Unity prototype already underway — further along than a typical concept doc.",
      es: "\"Una piedra. Un flick. El océano entero.\" Un juego de rebote de piedras basado en física, apuntando al pulido de las mejores arcade móviles, con un prototipo real en Unity ya en marcha — más avanzado que un documento de concepto típico.",
    },
    process: {
      en: [
