...
export function ProjectDetail({ project }: { project: Project }) {
  ...
  return (
    <article className="relative z-0 mx-auto max-w-6xl px-6 py-28">
      {washRgb && (
        <div
          aria-hidden
          style={{ "--project-wash": washRgb } as React.CSSProperties}
          className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[560px] bg-[radial-gradient(ellipse_70%_55%_at_50%_0%,rgb(var(--project-wash)/0.4),transparent_75%)] dark:bg-[radial-gradient(ellipse_70%_55%_at_50%_0%,rgb(var(--project-wash)/0.5),transparent_75%)]"
        />
      )}
      <Link
      ...
      <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-[1fr_300px] lg:gap-10">
        ...
        <div className="order-2 lg:order-none lg:col-start-2 lg:row-start-1 lg:sticky lg:top-28 lg:self-start">
        ...
        <p className="order-3 lg:order-none lg:col-start-1 lg:row-start-2 max-w-[68ch] leading-relaxed text-foreground/80">
        ...
        {project.links.length > 0 && (
          <div className="order-6 lg:order-none lg:col-start-1 lg:row-start-5 flex flex-wrap gap-4">
